...
<head>
    ...
    <title>QuickBite - Customer Home</title>
    ...
    <div id="student-interface" class="w-full h-full flex">
        ...
        <div class="flex flex-col w-64 bg-white shadow-xl h-full border-r border-gray-200 p-4">
            ...
            <div class="mb-4 p-3 bg-gray-100 rounded-lg">
                ...
                <p class="text-xs text-green-600">Customer</p>
            </div>
            ...
            <div class="mt-8 pt-4 border-t border-gray-200">
                <a href="../logout.php" class="w-full flex items-center p-3 rounded-xl transition duration-150 text-red-600 hover:bg-red-50">
        ...
        <div class="flex-1 overflow-y-auto p-8 bg-gray-50">
            ...
            <header class="mb-8">
                ...
                <p id="content-subtitle" class="text-gray-500">Fresh food prepared daily for our customers.</p>
            </header>

            <section id="menu-content" class="content-section">
                <div class="flex space-x-3 mb-6">
                    <button class="category-filter active bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-md" data-category="All Items">All Items</button>
                    <button class="category-filter bg-white text-gray-700 px-4 py-2 rounded-lg text-sm font-medium border hover:bg-gray-100 transition duration-150" data-category="Main Course">Main Course</button>
                    <button class="category-filter bg-white text-gray-700 px-4 py-2 rounded-lg text-sm font-medium border hover:bg-gray-100 transition duration-150" data-category="Sides">Sides</button>
                    <button class="category-filter bg-white text-gray-700 px-4 py-2 rounded-lg text-sm font-medium border hover:bg-gray-100 transition duration-150" data-category="Beverages">Beverages</button>
                </div>
